...
/// Data Repair Script for mushaf_v2_map.txt
/// 
/// This script reads the database glyph counts and merges text lines
/// to match the expected structure for all 604 pages.
/// 
/// Structural Exceptions:
/// 1. Surah 9 (At-Tawbah, Page 187): No Bismillah - first ayah follows header
/// 2. Pages 1-2: Bypassed (require manual coordinate mapping)
/// 3. Bismillah validation: Verifies basmallah line_type before processing
